...
export const detailMedia: VehicleDetailMedia = {
  colors: [
    { id: "super-blanco", name: "SÃºper blanco", image: { src: fortunerColor1, alt: "Toyota Fortuner, sÃºper blanco" } },
  ...
  gallery: [
    { src: fortunerGallery1, alt: "Toyota Fortuner, imagen 1 de la galerÃ­a" },
    { src: fortunerGallery2, alt: "Toyota Fortuner, imagen 2 de la galerÃ­a" },
    { src: fortunerGallery3, alt: "Toyota Fortuner, imagen 3 de la galerÃ­a" },
    { src: fortunerGallery4, alt: "Toyota Fortuner, imagen 4 de la galerÃ­a" },
    { src: fortunerGallery5, alt: "Toyota Fortuner, imagen 5 de la galerÃ­a" },
    { src: fortunerGallery6, alt: "Toyota Fortuner, imagen 6 de la galerÃ­a" },
    { src: fortunerGallery7, alt: "Toyota Fortuner, imagen 7 de la galerÃ­a" },
    { src: fortunerGallery8, alt: "Toyota Fortuner, imagen 8 de la galerÃ­a" },
    { src: fortunerGallery9, alt: "Toyota Fortuner, imagen 9 de la galerÃ­a" },
    { src: fortunerGallery10, alt: "Toyota Fortuner, imagen 10 de la galerÃ­a" },
    { src: fortunerGallery11, alt: "Toyota Fortuner, imagen 11 de la galerÃ­a" },
    { src: fortunerGallery12, alt: "Toyota Fortuner, imagen 12 de la galerÃ­a" },
  ],
  video: { src: fortunerVideo, title: "PresentaciÃ³n de la Toyota Fortuner" },
};
